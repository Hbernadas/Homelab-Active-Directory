...
In this stage, I installed and configured **Windows Server 2025** as the Domain Controller (DC) for my lab environment in a virtual machine. The process included downloading VMware and the recent ISO file, installing Active Directory Domain Services, and promoting the server to a DC.
